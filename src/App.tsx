  ...
  return (
    <ProtectedRoute fallback={authFallback}>
      ...
      >
        ...
        {error && (
          <div className="bg-amber-500/90 backdrop-blur text-slate-950 px-4 py-2 text-xs font-semibold flex items-center justify-between shadow-xs z-50">
        ...
        <main className="relative flex-1 overflow-hidden bg-slate-50">
          {(viewMode === 'canvas' || viewMode === 'overview') && (
