        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs font-medium text-slate-800 focus:border-indigo-500 focus:outline-hidden bg-white"
            >
              {allEntities.map((e) => (
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs font-medium text-slate-800 focus:border-indigo-500 focus:outline-hidden bg-white font-mono"
            >
          ...
          {sourceEntity && targetEntity && (
            <div className="flex items-center justify-between rounded-lg bg-slate-50 p-3 border border-slate-200 text-xs">
              ...
              <span className="font-semibold text-indigo-600 uppercase text-[10px] px-2.5 py-1 rounded-md bg-indigo-50 border border-indigo-200">
          ...
          <div className="flex justify-end gap-2 pt-3 border-t border-slate-100">
            ...
            <button
              type="submit"
              disabled={isCycle}
              className="rounded-xl bg-indigo-600 px-4 py-2 text-xs font-semibold text-white hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-xs cursor-pointer"
            >
              Create Edge Link
            </button>
          </div>
